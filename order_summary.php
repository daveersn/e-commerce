...
<body>
    <div class="min-h-full">
        <div class="p-3 pb-20 min-h-screen bg-gray-100">
            <div>
                <p class="text-center text-2xl font-bold tracking-wider my-2 mx-10 py-1 bg-red-400 border shadow-md rounded-2xl text-black">RIEPILOGO ORDINE</p>
            </div>
                    ...
                    <div class="flex flex-col flex-1">
                        ...
                        <div class="ml-3 flex justify-between items-center pr-4">
                            <div class="flex items-center">
                                <input type="checkbox" name="boccetta[]">
                                <label for="boccetta[]" class="text-sm pl-1">Boccetta <span class="text-xs">+1€</span></label>
                            </div>
                            <div>
                                <span class="font-semibold text-yellow-600">
                                <?= $mlqta?></span><span class="text-sm text-yellow-600">ml</span>
            ...
            <div class="flex justify-between">
                <div>
                    <p class="font-semibold tracking-wide pl-3">TOTALE: <span class="text-xl text-red-500 font-bold">10€</span></p>
